...
export default function UserPanel() {
    ...
    return (
        <div className="h-26 text-white p-3 flex items-center">
            <span
                ...
                {user ?
                    (
                        <>
                            {avatar ?
                                (
                                    <div className="w-12 h-12 rounded-full overflow-hidden mr-2 bg-gray-250 border-2 border-gray-700">
                                        <img
                                            src={Sprites.getAvatar(avatar)}
                                            className="w-10 h-10"
                                        />
                                    </div>
                                ) :
